...
const TablaResultados = () => {
  ...
  const handleAgregarResultados = () => {
    // Lógica para agregar resultados, puede incluir una llamada a la API
    Alert.alert('Agregar Resultados', 'Se están agregando los resultados...');
  };

  const handleTablaPosicionesClasificatoria = () => {
    // Lógica para navegar a la tabla de posiciones clasificatoria
    Alert.alert('Tabla Posiciones Clasificatoria', 'Se está navegando a la tabla de posiciones...');
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.btnGroupContainer}>
        <TouchableOpacity style={styles.btn} onPress={handleAgregarResultados}>
        ...
        <TouchableOpacity style={styles.btn} onPress={handleTablaPosicionesClasificatoria}>
