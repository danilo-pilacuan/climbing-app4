      ...
      case "detalle":
        return (
          <View style={styles.faseContainer}>
            ...
            <Text style={styles.value}>{competencia?competencia.nombreCom:""}</Text>
            <Text style={styles.label}>Modalidad Competencia:</Text>
            <Text style={styles.value}>Vias
            </Text>
          </View>
        );
      case "deportistas":
          ...
          <View style={styles.resItemContainer}>
            <View style={styles.resItemData}>
              ...
              <Text style={styles.label}>
                ...
                {item.labelMaxEscala2}({item.rankingVia2})
              </Text>
            </View>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.detailContainer}>
        <Text style={styles.title}>Detalle Competencia Vias</Text>
        <TouchableOpacity
          style={[
            styles.tab,
